...
class PyMySQL:
    ...
    def _init_(self, host, user, passwd, db, port=3306, charset='utf8'):
        ...
        try:
            ...
            print(self.getCurrentTime(),'ERROR: ', u"MySQL DB Connect Error :%d: %s" % (e.args[0], e.args[1]))
    ...
    def insertData(self, table, my_dict):
        try:
            ...
            try:
                ...
                # 发生错误时回滚
                self.db.rollback()
                print(self.getCurrentTime(),'ERROR: ', u"Data Insert Failed: %s" % (e))
                return 0
        except Exception as e:
            print(self.getCurrentTime(),'ERROR: ', u"MySQLdb Error: %s" % (e))
            return 0
...
class FundSpiders():
    ...
    def getFundCodesFromCsv(self):
        ...
        fund_code = pd.read_csv(filepath_or_buffer=file_path, encoding='gbk', dtype={'trade_code': pd.np.str})
    ...
    def getFundInfo(self, fund_code):
        ...
        try:
          ...
          '''
            ...
            print(self.getCurrentTime(),'ERROR: ', fund_code, fund_url, e)
        ...
        for tr in tab.findAll('tr'):
            ...
            if tr.findAll('td'):  # and len((tr.findAll('td')))==7 :
                ...
                try:
                    ...
                    print(self.getCurrentTime(), 'ERROR: ', 'getFundManagers1', fund_code, fund_url, e)
                ...
                try:
                    ...
                    print(self.getCurrentTime(), 'ERROR: ', 'getFundManagers2', fund_code, fund_url, e)
                ...
                for a in tr.findAll('a'):
                    if a:
                        try:
                            ...
                            print(self.getCurrentTime(),'ERROR: ', 'getFundManagers3', fund_code, manager['manager_name'],
                        ...
                        try:
                            ...
                            print(self.getCurrentTime(),'ERROR: ', 'getFundManagers4', fund_code, fund_url, e)
    ...
    def getFundNav(self, fund_code):
        ...
        try:
           ...
           '''
            ...
            print(self.getCurrentTime(),'ERROR: ', 'getFundNav1', fund_code, fund_url, e)
        try:
            ...
            print(self.getCurrentTime(),'ERROR: ', 'getFundNav2', fund_code, fund_url, e)
        ...
        for tr in tab.findAll('tr'):
            ...
            if tr.findAll('td') and len((tr.findAll('td'))) == 7:
                ...
                try:
                    ...
                    print(self.getCurrentTime(),'ERROR: ', 'getFundNav3', fund_code, fund_url, e)
                try:
                    ...
                    print(self.getCurrentTime(),'ERROR: ', 'getFundNav4', fund_code, fund_url, e)
            # 如果是货币基金，获取万份收益和7日年化利率
                ...
                try:
                    ...
                    print(self.getCurrentTime(),'ERROR: ', 'getFundNav5', fund_code, fund_url, e)
                try:
                    ...
                    print(self.getCurrentTime(),'ERROR: ', 'getFundNav6', fund_code, fund_url, e)
            else:
                pass
            # if i>=1:
            #     break
...
def main():
    ...
    for fund in funds:
        try:
            ...
            print(getCurrentTime(), 'ERROR: ', 'main', fund, e)
